      ...
      <section className='PromotionPage'>
        ...
        <div className='Promotion--Article__Container'>
          <div className='Promotion--Article__Section'>
            <h3>
              멋스러운 한옥.<br></br> 그 속에서 만나는 따뜻하고 세련된 감각
            </h3>
            <p>
              고풍스러우면서도 정감가는 한옥을 새롭게 인테리어해 지어진 훈콥스.
              이 곳에 들어서면 왠지 모를 편안함과 아늑함이 느껴지면서 마치
              전에도 한번 와 본 듯한 착각을 불러일으킨다. 한옥 자체가 주는
              따뜻함 때문일까? 여기에 세련된 소품들과 가구들이 주는 감각이
              더해져 훈콥스만의 고유한 분위기를 만들어 낸다.
            </p>
            <img
          ...
          <div className='Promotion--Article__Section'>
            <h3>
              개인의 취향을 존중받는 곳.<br></br>훈콥스의 감성과 색, 그리고
              이야기
            </h3>
            <p>
              훈콥스의 모든 것은 사장님의 개인적인 취향이다. 그는 훈콥스라는
              공간 안에서 꾸준히 구석구석 본인의 색과 손길을 담았다. 손님들은
              그저 그가 오랜시간에 걸쳐 정성껏 만들어 놓은 훈콥스라는 공간을
              다시금 저마다의 취향대로 차분히 즐기고 가면 그만이다. 훈콥스에서는
              어떤 '특정한 감성'을 느끼려고 노력할 필요가 없다.
            </p>
          </div>
          <div className='Promotion--Article__Section'>
            <img
